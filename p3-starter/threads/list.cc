...
//----------------------------------------------------------------------
// List::GetElementAt
//     Returns the element at a given index, or NULL if that index is empty.
//----------------------------------------------------------------------

void* List::GetElementAt(int index)
{
    int i = 0;
    ListElement* currElement = first;
...
void List::Remove(void* element)
{
    List tempList;
    void* currElement = Remove();

    // Copy good elements over to temp list, removing param elem
    while (currElement != NULL)
    {
        if (currElement != element) {
            tempList.Append(currElement);
        }
        currElement = Remove();
    }
    currElement = tempList.Remove();

    // Copy good elements back to this list
    while (currElement != NULL)
    {
        Append(currElement);
        currElement = tempList.Remove();
