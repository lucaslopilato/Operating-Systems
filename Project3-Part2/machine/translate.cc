...
// from the virtual address
    ...
    //int swapPageIndex = entry->locationOnDisk / PageSize;
    //SwapSectorInfo * swapPageInfo = virtualMemoryManager->getSwapSpacePageInfo(swapPageIndex);
    //swapPageInfo->setUseBit(TRUE);
    if (writing)
    {
    entry->dirty = TRUE;
        //swapPageInfo->setDirtyBit(TRUE);
    }
